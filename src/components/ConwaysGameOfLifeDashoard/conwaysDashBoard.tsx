...
import "../ConwaysGameOfLifeDashoard/main.css";

export const ConwaysDashboard = (props:any) => {
    return (
        <>
    <div className="icon-container">
    <svg viewBox="0 0 448 512" width="21"  className="run">
      <path d="M424.4 214.7L72.4 6.6C43.8-10.3 0 6.1 0 47.9V464c0 37.5 40.7 60.1 72.4 41.3l352-208c31.4-18.5 31.5-64.1 0-82.6z" />
    </svg>

    <svg viewBox="0 0 512 512" width="26"  className="pause">
    ...
    <svg viewBox="0 0 512 512" width="26" className="restart">
    ...
    <svg viewBox="0 0 448 512" width="31"  className="next-gen">
      ...
      <div className="dashstyle"></div>
          <div className="dashboard">
              <nav>
                  ...
                  <a onClick={() => { props.pause(); }}>Pause</a>
                  <a onClick={() => { props.restart(); }}>Restart</a>
                  <a onClick={() => { props.nexGen(); }}>Next Gen</a>
              </nav>
          </div>
      </div>
    </>
